...
import dev.arkbuilders.rate.feature.onboarding.Spotlight
import dev.arkbuilders.rate.feature.onboarding.SpotlightShape
import dev.arkbuilders.rate.feature.onboarding.SpotlightTooltip
import dev.arkbuilders.rate.feature.onboarding.TooltipPosition
    ...
    Box {
        Column {
            QuickEmpty(
                ...
                calculateModifier = Modifier.onGloballyPositioned { coordinates ->
                    calculateRect = coordinates.boundsInRoot()
                }
            )
            MockBottomNavigation(
                portfolioModifier = Modifier.onGloballyPositioned { coordinates ->
                    portfolioRect = coordinates.boundsInRoot()
                },
                pairAlertModifier = Modifier.onGloballyPositioned { coordinates ->
...
@Composable
fun QuickEmpty(modifier: Modifier, calculateModifier: Modifier) {
