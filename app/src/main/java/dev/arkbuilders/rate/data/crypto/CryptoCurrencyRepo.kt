...
@Singleton
class CryptoCurrencyRepo @Inject constructor(private val cryptoAPI: CryptoAPI,
    ...
    override suspend fun fetchRemote(): List<CurrencyRate> = cryptoAPI.getCryptoRates()
    ...
    override suspend fun currencyNameByCode(code: CurrencyCode) = CurrencyName(code, name = "")
}